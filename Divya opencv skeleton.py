...
def lane_check_4(q4,fg4,value):
    ...
    while time.time() < t_end:
        ...
        cv2.imshow('video2', frames)                                # Display frames in a window
        if cv2.waitKey(33) == 27 or max(set_lane_4)>threshold:            #threshold ki jagah 10 dala hai                       # Wait for Esc key to stop
            # value[0] = 1
            # value[1] = 1
            # value[2] = 1
            # value[3] = 1
    ...
    with multiprocessing.Manager() as manager:
        ...
        while True:
            ...
            if flag1==1 or flag2==1 or flag3==1 or flag4==1:
                ...
                print(lane_order)
                l=list()
                s={'lane_1':lane_order[0],'lane_2':lane_order[1],'lane_3':lane_order[2],'lane_4':lane_order[3]}
