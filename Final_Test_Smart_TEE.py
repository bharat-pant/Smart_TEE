...
def ambulance_call(blue):
    ...
    #global count
    while len(blue) != 0:
        print("blue[0] ki value ye hai",blue[0])
        print(type(blue[0]))
        if blue[0] == 1:
...
def normal_timer():
    ...
    if count % 4 == 1:
        ...
        while time.time() < normal_time_lane_1:
            ...
            a = bluetooth_call()
            if len(a) != 0:
                if (time.time()<(normal_time_lane_1-10)):
                    count=count-1
        ...
        while time.time() < normal_time_lane_2:
            ...
            a = bluetooth_call()
            if len(a) != 0:
                if (time.time()<(normal_time_lane_2-10)):
                    count=count-1
                print("Ambulance call")
                GPIO.cleanup()
                ambulance_call(a)
        ...
        while time.time() < normal_time_lane_3:
            ...
            a = bluetooth_call()
            if len(a) != 0:
                if (time.time()<(normal_time_lane_3-10)):
                    count=count-1
                print("Ambulance call")
                GPIO.cleanup()
                ambulance_call(a)
        ...
        while time.time() < normal_time_lane_4:
            ...
            a=bluetooth_call()
            if len(a) != 0:
                if (time.time()<(normal_time_lane_4-10)):
                    count=count-1
                print("Ambulance call")
                GPIO.cleanup()
                ambulance_call(a)
    ...
    with multiprocessing.Manager() as manager:
        ...
        while True:
            ...
            if flag1 == 1 or flag2==1 or flag3==1 or flag4==1:
                ...
                time1,time2,time3,time4=40,40,40,40
                print(time1,time2,time3,time4)
            number_of_cars=[]
            ...
            for i in range(order.qsize()):
                ...
                print("me hoo giaaaaan")
                normal_timer()
                print("me hoo udta robot doraemon number", count)
